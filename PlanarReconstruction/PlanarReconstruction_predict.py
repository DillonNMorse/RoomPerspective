...
from PlanarReconstruction.models.baseline_same import Baseline as UNet
from PlanarReconstruction.utils.disp import tensor_to_image
from PlanarReconstruction.utils.disp import colors_256 as colors
from PlanarReconstruction.bin_mean_shift import Bin_Mean_Shift
from PlanarReconstruction.modules import get_coordinate_map
from PlanarReconstruction.utils.loss import Q_loss
from PlanarReconstruction.instance_parameter_loss import InstanceParameterLoss
...
def predict(image_path, save_path):
    ...
    import yaml
    yaml.full_load
    with open('./PlanarReconstruction/configs/predict.yaml') as file:
        pr = yaml.load(file,
    ...
    data_path = './PlanarReconstruction/ckpt/pretrained.pt'
    model_dict = torch.load(data_path, map_location=lambda storage, loc: storage)
...
# =============================================================================
    ...
    with torch.no_grad():
        ...
        # Save arrays to disk
        np.save(save_path + '_segmentation', predict_segmentation)
        np.save(save_path + '_depth2', depth)
...
#         fig = plt.figure()
#         plt.imshow(image)
#         plt.savefig(save_path + '_label.jpg')
# =============================================================================
